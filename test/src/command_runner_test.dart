...
import 'package:clean_flu_cli/src/command_runner.dart';
...
void main() {
  group('CleanFluCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late CleanFluCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = CleanFluCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = CleanFluCliCommandRunner();
